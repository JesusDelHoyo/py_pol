...
from .__init__ import degrees, eps, np, num_decimals, um, number_types
...
class Jones_matrix(Py_pol):
    ...
    def prod(self, axis=None, keep=False, change_name=change_names):
        ...
        # Complicated case
            ...
            M = np.zeros(shape_final, dtype=complex)
    ...
    def from_Mueller(self, M, length=1, shape_like=None, shape=None):
        ...
        References:
            ...
            Polarized Light and the Mueller matrix approach, J. J. Gil, pp 109.
    ...
    def diattenuator_general(self,
                            ...
                            shape=None,
                            force_limits=False):
        """Creates the general homogeneous diattenuator.
        ...
        Parameters:
            ...
            shape_like (numpy.ndarray or py_pol object): Use the shape of this object. Default: None.
            shape (tuple or list): If no shape_like array is given, use this shape instead. Default: None.
            force_limits (bool): If True, the values of alpha and delay (if applicable) are forced to be in the range [0, pi/2] and [0, 2*pi) respectively. Default: False.

        Returns:
            (Jones_matrix): Created object.
        """
        # Prepare variables
        if alpha is None and delay is None:
            alpha, delay = azimuth_elipt_2_charac_angles(azimuth=azimuth,
                                                     ellipticity=ellipticity)
        # Calculate
        return self.diattenuator_charac_angles(p1=p1,
                                        p2=p2,
                                        Tmax=Tmax,
                                        Tmin=Tmin,
                                        alpha=alpha,
    ...
    def diattenuator_azimuth_ellipticity(self,
                                         ...
                                         shape=None,
                                         force_limits=False):
        """Creates the general homogeneous diattenuator from the characteristic angles of the main eigenstate.
    ...
    def diattenuator_charac_angles(self,
                                   ...
                                   shape=None,
                                   force_limits=False):
        """Creates the most general homogenous diattenuator from the characteristic angles of the main eigenstate.
    ...
    def retarder_linear(self,
                        ...
                        force_limits=False,
                        R=None):
        """Creates a retarder with linear states as fast and slow axes.
    ...
    def retarder_general(self,
                        ...
                        force_limits=False,
                        R=None):
        """Function that calculates the most general homogeneous diattenuator.
        ...
        if alpha is None or delay is None:
            ...
            alpha, delay = azimuth_elipt_2_charac_angles(azimuth=azimuth,
                                                        ellipticity=ellipticity)
        # Calculate
        return self.retarder_charac_angles(ret,
                                    alpha,
                                    delay,
                                    global_phase=global_phase,
                                    length=length,
    ...
    def retarder_azimuth_ellipticity(self,
        ...
        Parameters:
            ...
            shape_like (numpy.ndarray or py_pol object): Use the shape of this object. Default: None.
            shape (tuple or list): If no shape_like array is given, use this shape instead. Default: None.
            force_limits (bool): If True, the values of R, azimuth and ellipticity are forced to be in [0, pi], [0, pi) and [-pi/4, pi/4] respectively. Default: False.
            R (float or None): Same as ret, overrides it if it is not None. Maintained for retrocompatibility. Default: None.
    ...
    def retarder_charac_angles(self,
        ...
        Parameters:
            ...
            shape_like (numpy.ndarray or py_pol object): Use the shape of this object. Default: None.
            shape (tuple or list): If no shape_like array is given, use this shape instead. Default: None.
            force_limits (bool): If True, the values of R, alpha and delay are forced to be in the range [0, pi], [0, pi/2] and [0, 2*pi) respectively. Default: False.
            R (float or None): Same as ret, overrides it if it is not None. Maintained for retrocompatibility. Default: None.
    ...
    def diattenuator_retarder_general(self,
        ...
        Parameters:
            ...
            shape_like (numpy.ndarray or py_pol object): Use the shape of this object. Default: None.
            shape (tuple or list): If no shape_like array is given, use this shape instead. Default: None.
            force_limits (bool): If True, the values of azimuth and ellipticity or alpha and delay (but not R) are forced to be in their correct range. Default: False.
            R (float or None): Same as ret, overrides it if it is not None. Maintained for retrocompatibility. Default: None.
        ...
        E1.diattenuator_charac_angles(p1=p1,
                                        ...
                                        force_limits=False)
        E2 = Jones_matrix()
        E2.retarder_charac_angles(ret=ret,
                                alpha=alpha,
                                delay=delay,
                                shape=shape,
                                shape_like=shape_like,
    ...
    def diattenuator_retarder_azimuth_ellipticity(self,
        ...
        Parameters:
            ...
            shape_like (numpy.ndarray or py_pol object): Use the shape of this object. Default: None.
            shape (tuple or list): If no shape_like array is given, use this shape instead. Default: None.
            force_limits (bool): If True, the values of azimuth and ellipticity are forced to be in the range [0, pi) and [-pi/4, pi/4] respectively. Values of R are not forced. Default: False.
            R (float or None): Same as ret, overrides it if it is not None. Maintained for retrocompatibility. Default: None.
        ...
        E1.diattenuator_azimuth_ellipticity(p1=p1,
                                            ...
                                            force_limits=False)
        E2 = Jones_matrix()
        E2.retarder_azimuth_ellipticity(ret=ret,
                                        azimuth=azimuth,
                                        ellipticity=ellipticity,
                                        shape=shape,
                                        shape_like=shape_like,
    ...
    def diattenuator_retarder_charac_angles(self,
        ...
        Parameters:
            ...
            shape_like (numpy.ndarray or py_pol object): Use the shape of this object. Default: None.
            shape (tuple or list): If no shape_like array is given, use this shape instead. Default: None.
            force_limits (bool): If True, the values of alpha and delay are forced to be in the range [0, pi/2] and [0, 2*pi) respectively. R values are not affected. Default: False.
            R (float or None): Same as ret, overrides it if it is not None. Maintained for retrocompatibility. Default: None.
    ...
    def biaxial_material(self,
        ...
        """
        # Prepare variables
        kd = 2 * np.pi * thickness / wavelength
        z = np.zeros_like(ne)
        # Calculate ne due to rotation
        ne = (np.cos(rotation)**2 / ne**2 + np.sin(rotation)**2 / no**2)**-0.5
        # Calculate
        self.from_components([np.exp(1j * ne * kd), z, z, np.exp(1j * no * kd)], length=length, shape_like=shape_like, shape=shape)
        self.no_rotation = False
        self.rotate(azimuth)
        return self
    ...
    def general_eigenstates(self,
        ...
        Parameters:
            ...
            Tmax (float or numpy.ndarray): Maximum transmission. If not None, overrides p1. Default: None.
            Tmin (float or numpy.ndarray): Minimum transmission. If not None, overrides p2. Default: None.
            ret (float or numpy.ndarray): Retardance. Default: 90 degrees.
            global_phase (float or numpy.ndarray): Global phase introduced by the optical element. Default: 0.
            length (int): If final object is of size 1, it is stretched to match this size. Default: 1.
            shape_like (numpy.ndarray or py_pol object): Use the shape of this object. Default: None.
            shape (tuple or list): If no shape_like array is given, use this shape instead. Default: None.
...
class Parameters_Jones_Matrix(object):
    ...
    def global_phase(self,
        ...
        # #If J00 is zero, extract the global phase of J11 element
        # if not phase.all():
        #     _, _, _, J11 = self.components(out_number=out_number, shape=False)
        #     phase = np.angle(J11) % (2 * np.pi)
        # Reshape if neccessary
        phase = reshape([phase],
                        shape_like=shape_like,
                        shape_fun=shape,
    ...
    def transmissions(self,
        ...
        arg = norm2**2 - 4 * np.abs(det)**2
        if arg.any() > -1e-10:
            arg = np.abs(arg)
            
        T_max = (norm2 + np.sqrt(arg)) / 2
        T_min = (norm2 - np.sqrt(arg)) / 2
...
class Checks_Jones_Matrix(object):
    ...
    def is_retarder(self,
        ...
        Returns:
            (numpy.ndarray or bool): Result.
        """
        #Remove global_phase before checking if it is a polarizer
        obj = self.parent.remove_global_phase(keep=True)
        
        # Calculate the hermitian conjugate
        H = obj.hermitian(keep=True)
    ...
    def is_polarizer(self,
        ...
        cond = obj.checks.is_diattenuator(out_number=True,
                                    shape_like=None,
                                    shape=None)
        # Reshape if neccessary
        cond = reshape([cond],
...
class Analysis_Jones_Matrix(object):
    ...
    def diattenuator(self,
        ...
        Returns:
            trans (list): List including Tmax, Tmin, p1 and p2 (wich appear only if requested).
            state (list): List with alpha, delay, azimuth and ellipticity of the transmission state (wich appear only if requested).
        """
        # Calculate transmissions
    ...
    def retarder(self,
        ...
        R = self.parent.parameters.retardance(out_number=False, shape=shape, shape_like=shape_like)
        # Calculate the components
        comp = self.parent.parameters.components(out_number=False, shape=shape, shape_like=shape_like)        
        phase_01 = np.angle(comp[1])
        phase_10 = np.angle(comp[2])
        
        # Fix numerical error of arcsin.
        arg = np.abs(comp[1]) / np.sin(R / 2)
        cond = np.arcsin(arg) > 1
        
        if np.any(~cond):
            arg[~cond] = 1

        # Calculate the angles
        alpha = 0.5 * np.arcsin(arg)
        ...
        delay = put_in_limits(delay, 'delay', out_number=False)
